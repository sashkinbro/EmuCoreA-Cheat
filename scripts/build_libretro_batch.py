...
SERIALS = {
    ...
    # Batch 017: 100 additional PSP serials from the same pinned libretro snapshot.
    ...
    # Batch 018: 100 additional PSP serials from the same pinned libretro snapshot.
    ...
    # Batch 019: 100 additional PSP serials from the same pinned libretro snapshot.
